...
router.route("/temples/:id").get((req, res) => templeController.get(req, res));

router
  .route("/temples/:id")
  .delete((req, res) => templeController.delete(req, res));

router
  .route("/temples/:id")
  .put((req, res) => templeController.update(req, res));
